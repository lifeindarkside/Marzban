...
Если Вы хотите использовать `marzban-cli`, необходимо связать его с файлом в `$PATH`, сделать файл исполняемым и установить его:
...
В конце запустите приложение с помощью следующей команды:
